...
#' @usage data(FC)
#'
#' @format A data frame with 1000 observations on 105 variables. For a variable
...
#'
#set.seed(69)
#FC <- sim.data(3,15,1000,rep(1:3,5),lmu=runif(15,-1,1),varcov=diag(3),loadings=runif(15,.3,.9))
#save(FC, file="../data/FC.rda")
#write.table(FC,'myDataFile.dat',quote=FALSE, sep=" ", col.names = FALSE, row.names = FALSE)
"FC"
